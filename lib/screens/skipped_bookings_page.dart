...
class SkippedBookings extends StatelessWidget {
  const SkippedBookings({super.key});
              ...
              Padding(
                ...
                child: Row(
                  children: [
                    Icon(
                      Icons.warning,
                      color: Color(0xffFC3F3F),
                    ),
                    SizedBox(width: 5),
                    Text(
                      'Skipping Service repeatedly might pause your profile\ntemporarily.',
                      style: TextStyle(
                        fontFamily: 'Outfit',
                        fontSize: 14,
